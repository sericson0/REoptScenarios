...
function grid_costs_scenario(m::JuMP.AbstractModel, params::Dict, scenario::Scenario)
	...
	add_scenario_results(params["results"], scenario, "utility"; gen = grid_purchases, load = load, other_results = tariff_return_vals)
