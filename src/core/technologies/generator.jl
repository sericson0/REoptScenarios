...
function generator_scenario(m, params, scenario, limited_fuel = false)
	g = params["generator"]

	if g.only_runs_during_grid_outage
	...
	if limited_fuel
		...
		@constraint(m, fuel_remaining[t0] == params["generator"].fuel_avail_gal)
